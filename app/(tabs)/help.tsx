        ...
        <View style={styles.contentContainer}>
          ...
          <View style={styles.heroSection}>
            ...
            <Text style={styles.heroSubtitle}>
              Play videos from your Jellyfin server on your Apple TV
            </Text>
          </View>
          ...
          >
            ...
            <Text style={styles.cardText}>
              Play any video from Jellyfin servers on your Apple TV — no manual
              encoding required. Tomo TV automatically handles videos that
              won&apos;t normally play, so you can just hit play and watch.
            </Text>
          </Pressable>
          ...
          <Pressable style={styles.helpCard} isTVSelectable={true}>
            ...
            <Text style={styles.helpCardText}>
              These formats are converted to H.264/AAC on-the-fly when TomoTV
              detects they cannot be direct-played.
            </Text>
          </Pressable>
          ...
          <Pressable style={styles.helpCard} isTVSelectable={true}>
            ...
            <Text style={styles.helpCardText}>
              Tune the default bitrate/resolution under Settings → Video
              Quality.
            </Text>
            ...
            <View style={styles.featuresGrid}>
              <Pressable style={styles.featureCard} isTVSelectable={true}>
                ...
                <Text style={styles.featureText}>
                  Seamless video streaming with server-side transcoding
                </Text>
              </Pressable>
          ...
          <Pressable style={styles.card} isTVSelectable={true}>
            ...
            <Text style={styles.helpCardText}>
              Quick checks when playback fails or a device cannot connect.
            </Text>
            ...
            <View style={styles.infoList}>
              <View style={styles.infoItem}>
                ...
                <View style={styles.infoContent}>
                  ...
                  <Text style={styles.infoText}>
                    Turn on hardware or software transcoding in Jellyfin →
                    Dashboard → Playback when codecs fail to direct-play.
                  </Text>
                </View>
              </View>
              ...
              <View style={styles.infoItem}>
                ...
                <View style={styles.infoContent}>
                  ...
                  <Text style={styles.infoText}>
                    External subtitle tracks are detected automatically;
                    embedded ones are burned in during transcoding.
                  </Text>
                </View>
              </View>
              ...
              <View style={styles.infoItem}>
                ...
                <View style={styles.infoContent}>
                  ...
                  <Text style={styles.infoText}>
                    Keep TomoTV and Jellyfin on the same LAN or VPN for the most
          ...
          <Pressable style={styles.noticeBox} isTVSelectable={true}>
            ...
            <Text style={styles.noticeText}>
              If your server IP changes, open TomoTV Settings, update the
              address, and tap Test Connection before launching playback on
              Apple TV.
            </Text>
          </Pressable>
