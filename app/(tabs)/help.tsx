            ...
            <View style={styles.infoList}>
              <View style={styles.infoItem}>
                ...
                <View style={styles.infoContent}>
                  ...
                  <Text style={styles.infoText}>
                    Make sure transcoding is enabled in your Jellyfin server
                    settings.
                  </Text>
                </View>
              </View>
              ...
              <View style={styles.infoItem}>
                ...
                <View style={styles.infoContent}>
                  ...
                  <Text style={styles.infoText}>
                    Subtitle tracks are automatically detected and included in
                    the video.
                  </Text>
                </View>
              </View>
              ...
              <View style={styles.infoItem}>
                ...
                <View style={styles.infoContent}>
                  <Text style={styles.infoTitle}>Streaming</Text>
                  <Text style={styles.infoText}>
                    Videos stream directly from your server in real-time.
                  </Text>
                </View>
              </View>
            </View>
