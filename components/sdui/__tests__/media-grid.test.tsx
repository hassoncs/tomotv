...
jest.mock("@/components/video-grid-item", () => ({
  VideoGridItem: ({ video, onPress, index }: { video: { Id: string; Name: string }; onPress: (v: { Id: string }) => void; index: number }) => {
...
describe("MediaGrid component", () => {
  ...
  it("renders without crashing", () => {
    ...
    expect(() => create(<MediaGrid items={items} title="Test" columns={4} onSelectId={undefined} />)).not.toThrow();
  });
